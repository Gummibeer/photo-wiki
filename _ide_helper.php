...
namespace {
    ...
    class Finediff extends \Gummibeer\Finediff\Facades\Finediff{
         ...
         * @static 
         */
        public static function getOpCode($stringOne, $stringTwo, $granularity = 'word'){
            return \Gummibeer\Finediff\Lib\Finediff::getOpCode($stringOne, $stringTwo, $granularity);
        }
         ...
         * @static 
         */
        public static function getHtmlByOpCode($stringOne, $opCode, $granularity = 'word'){
            return \Gummibeer\Finediff\Lib\Finediff::getHtmlByOpCode($stringOne, $opCode, $granularity);
        }
         ...
         * @static 
         */
        public static function getHtmlByStrings($stringOne, $stringTwo, $granularity = 'word'){
            return \Gummibeer\Finediff\Lib\Finediff::getHtmlByStrings($stringOne, $stringTwo, $granularity);
        }
         ...
         * @static 
         */
        public static function getTextByOpCode($stringOne, $opCode, $granularity = 'word'){
            return \Gummibeer\Finediff\Lib\Finediff::getTextByOpCode($stringOne, $opCode, $granularity);
        }
         ...
         * @static 
         */
        public static function getTextByStrings($stringOne, $stringTwo, $granularity = 'word'){
            return \Gummibeer\Finediff\Lib\Finediff::getTextByStrings($stringOne, $stringTwo, $granularity);
        }
    ...
    class BTForm extends \Watson\BootstrapForm\Facades\BootstrapForm{
    ...
    class Notifynder extends \Fenos\Notifynder\Facades\Notifynder{
        ...
        public static function category($category){
            return \Fenos\Notifynder\Managers\NotifynderManager::category($category);
        }
        ...
        public static function loop($data, $callback){
            return \Fenos\Notifynder\Managers\NotifynderManager::loop($data, $callback);
        }
         ...
         * @static 
         */
        public static function builder($new = false){
            return \Fenos\Notifynder\Managers\NotifynderManager::builder($new);
        }
        ...
        public static function send(){
            return \Fenos\Notifynder\Managers\NotifynderManager::send();
        }
        ...
        public static function sender(){
            return \Fenos\Notifynder\Managers\NotifynderManager::sender();
        }
         ...
         * @static 
         */
        public static function extend($name, $sender){
            return \Fenos\Notifynder\Managers\NotifynderManager::extend($name, $sender);
        }
    ...
    class GoogleCalendar extends \Spatie\GoogleCalendar\GoogleCalendarFacade{
        ...
        public static function getCalendarId(){
            return \Spatie\GoogleCalendar\GoogleCalendar::getCalendarId();
        }
         ...
         * @static 
         */
        public static function listEvents($startDateTime = null, $endDateTime = null, $queryParameters = array()){
            return \Spatie\GoogleCalendar\GoogleCalendar::listEvents($startDateTime, $endDateTime, $queryParameters);
        }
        ...
        public static function getEvent($eventId){
            return \Spatie\GoogleCalendar\GoogleCalendar::getEvent($eventId);
        }
        ...
        public static function insertEvent($event){
            return \Spatie\GoogleCalendar\GoogleCalendar::insertEvent($event);
        }
        ...
        public static function updateEvent($event){
            return \Spatie\GoogleCalendar\GoogleCalendar::updateEvent($event);
        }
        ...
        public static function deleteEvent($eventId){
            return \Spatie\GoogleCalendar\GoogleCalendar::deleteEvent($eventId);
        }
        ...
        public static function getService(){
            return \Spatie\GoogleCalendar\GoogleCalendar::getService();
        }
    ...
    class Helper extends \App\Facades\HelperFacade{
         ...
         * @static 
         */
        public static function getLogContext($context = array()){
            return \App\Libs\Helper::getLogContext($context);
        }
         ...
         * @static 
         */
        public static function mixedGet($object, $key, $default = null){
            return \App\Libs\Helper::mixedGet($object, $key, $default);
        }
         ...
         * @static 
         */
        public static function translate($message, $arguments = array()){
            return \App\Libs\Helper::translate($message, $arguments);
        }
        ...
        public static function getUserLanguage(){
            return \App\Libs\Helper::getUserLanguage();
        }
         ...
         * @static 
         */
        public static function isRoute($arg){
            return \App\Libs\Helper::isRoute($arg);
        }
        ...
        public static function isJson($json){
            return \App\Libs\Helper::isJson($json);
        }
         ...
         * @static 
         */
        public static function isActiveLdap(){
            return \App\Libs\Helper::isActiveLdap();
        }
        ...
        public static function getStub($file){
            return \App\Libs\Helper::getStub($file);
        }
         ...
         * @static 
         */
        public static function formatCliToHtml($string){
            return \App\Libs\Helper::formatCliToHtml($string);
        }
         ...
         * @static 
         */
        public static function bashColorToHtml($string){
            return \App\Libs\Helper::bashColorToHtml($string);
        }
         ...
         * @static 
         */
        public static function getGeolocByAddress($address){
            return \App\Libs\Helper::getGeolocByAddress($address);
        }
        ...
        public static function getLanguageFromLocale($locale){
            return \App\Libs\Helper::getLanguageFromLocale($locale);
        }
         ...
         * @static 
         */
        public static function formatCarbonDatetime($carbon){
            return \App\Libs\Helper::formatCarbonDatetime($carbon);
        }
        
    }


    class Datamap extends \App\Facades\DatamapFacade{
        ...
        public static function getYesNo($id = null){
            return \App\Libs\Datamap::getYesNo($id);
        }
         ...
         */
        public static function getLanguages(){
            return \App\Libs\Datamap::getLanguages();
        }
         ...
         * @static 
         */
        public static function getNotificationStyles(){
            return \App\Libs\Datamap::getNotificationStyles();
        }
         ...
         * @static 
         */
        public static function getNotificationStyle($name){
            return \App\Libs\Datamap::getNotificationStyle($name);
        }
         ...
         * @static 
         */
        public static function getNotificationStyleByCategory($category){
            return \App\Libs\Datamap::getNotificationStyleByCategory($category);
        }
        ...
        public static function getCalendars(){
            return \App\Libs\Datamap::getCalendars();
        }
         ...
         * @static 
         */
        public static function getCalendarById($gcid){
            return \App\Libs\Datamap::getCalendarById($gcid);
        }
         ...
         * @static 
         */
        public static function getCalendarByName($name){
            return \App\Libs\Datamap::getCalendarByName($name);
        }
